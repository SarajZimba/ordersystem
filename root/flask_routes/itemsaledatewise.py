...
#         query = '''select b.date, count(a.count) , b.Outlet_Name, b.`Type` from tblorder_detailshistory a, tblorderhistory b where a.order_ID = b.idtblorderHistory and b.date between %s and %s and a.ItemName = %s group by b.date,  b.Outlet_Name order by b.date'''
...
#         transformed_sales_data = list(grouped_sales_data.values())   
